...
import pages.materia.comentario.FormularioBotaoDenunciar;
...
public class FormularioBotaoDenunciarTest {
	
	private static FormularioBotaoDenunciar materia;
	...
	public static void antesDeCadaTeste() throws Exception {
		materia = new FormularioBotaoDenunciar(Navegador.CHROME);
	...
	@Test
	public void verificaSeEstaSendoExibidoOBotaoDeDenunciar() throws Exception{
		assertTrue(materia.exibiuOBotaoDeDununciar());
	}
	
	@OrdemExecucaoTeste(Ordem=3)
	@Test
	public void verificaSeEstaOTituloResponderEstaSendoExibido() throws Exception{
		String tituloEsperado = "DENUNCIAR";
		materia.esperaCarregar(3);
	...
	@Test
	public void verificaSeONomeDoUsuarioEstaSendoExibidoNaCaixaDeComentario() throws InterruptedException {
		materia.executarScroll(materia.listaComTodosOsComentarios().get(0).findElement(By.className("form")).getLocation());
		materia.esperaCarregar(3);
		assertTrue(materia.exibiuONomeDoUsuarioEmBranco());
	}
