...
public class MensagemComentarioCaptchaIncorretoTest {
	...
	public void verificaSeAMensagemDeComentarioInvalidoEstaSendoExibido() throws InterruptedException {
		String mensagemDeErroEsperada = "O texto não corresponde à imagem.";
		materia.preencherComentarioComTextoValido();
		materia.preencherOCaptcha();
		materia.apertarOEnter();
		materia.esperaCarregar3Segundos();
		assertEquals(mensagemDeErroEsperada, materia.exibiuMensagemDeErroDoCaptcha());
	}
