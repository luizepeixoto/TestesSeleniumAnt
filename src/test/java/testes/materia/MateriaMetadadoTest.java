...
import pages.materia.MateriaMetadado;


public class MateriaMetadadoTest {
	
	private static MateriaMetadado materia;
	private String contextoPagina = materia.exibiuCodigoFonteDaPagina(); 
	
	@BeforeClass
	public static void antesDeCadaTeste() throws Exception {
		materia = new MateriaMetadado();
	}
