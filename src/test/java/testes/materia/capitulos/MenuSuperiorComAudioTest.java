...
import pages.materia.capitulo.MenuSuperiorComAudio;
...
public class MenuSuperiorComAudioTest {
	
	private static MenuSuperiorComAudio materiaEmCapitulo;
	...
	public static void antesDeCadaTeste() throws Exception {
		materiaEmCapitulo = new MenuSuperiorComAudio(Navegador.CHROME);
