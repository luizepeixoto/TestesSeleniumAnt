...
import pages.materia.capitulo.MenuSuperiorElementosEmbedGenerico;
...
public class MenuSuperiorComElementosDoEmbedGenericoTest { 
	
	private static MenuSuperiorElementosEmbedGenerico materia;
	...
	public static void antesDeCadaTeste() throws Exception {
		materia = new MenuSuperiorElementosEmbedGenerico(Navegador.CHROME);
	...
	12º Capítulo - Widget de Audio: Utilizado no MenuSuperiorComAudioTest.java*/
