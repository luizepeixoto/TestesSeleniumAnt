...
import pages.materia.capitulo.MenuLateralComComentario;

import br.com.infoglobo.pages.Navegador;
import br.com.infoglobo.pages.RegraTirarScreenShot;

public class MenuLateralComComentarioTest {
	
	private static MenuLateralComComentario materia;
	...
	public static void antesDeCadaTeste() throws Exception {
		materia = new MenuLateralComComentario(Navegador.CHROME);
