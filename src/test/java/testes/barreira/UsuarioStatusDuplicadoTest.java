...
public class UsuarioStatusDuplicadoTest {
	...
	public void verificaSeOUsuarioFoiRedirecionadoParaAUltimaURLAcessadaAntesDeCairNaPaginaDeDegustacao() throws Exception{
		...
		System.out.println("ultima: " + degustacao.getUrlPaginaAtual());
	...
	@Test
	public void verificaSeAposNavegarPorMaisDezMateriasOStatusDeAcessoDoPaywallPassaASerPNDuplicado() throws Exception{
		fluxoPaywall();
		assertTrue(degustacao.exibiuOStatusDoCookiedoPaywallComoDuplicado());		
    }
	
	@OrdemExecucaoTeste(Ordem=5)
	@Test
	public void verificaSeOUsuarioPNDuplicadoecebeuAMensagemDeEntrarEmContatoComALoja() throws Exception{
		assertTrue(degustacao.exibiuMensagemDeEntrarEmContatoParaAssinaturaDigitalComProblema());		
    }
