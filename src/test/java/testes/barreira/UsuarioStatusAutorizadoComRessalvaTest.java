...
public class UsuarioStatusAutorizadoComRessalvaTest {
	...
	public void fluxoNavegacaoPaywall() throws Exception{
		...
		login.efetuarLoginAutorizadoComRessalva();
	...
	public void verificaSeAposNavegarPorMaisDezMateriasOStatusDeAcessoDoPaywallPassaASerAutorizadoComRessalva() throws Exception{
		fluxoPaywall();
		assertTrue(degustacao.exibiuOStatusDoCookiedoPaywallComoAutorizadoComRessalva());		
    }
