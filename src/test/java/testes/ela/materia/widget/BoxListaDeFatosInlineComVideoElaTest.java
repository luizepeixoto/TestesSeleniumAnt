...
import pages.ela.materia.widget.BoxListaDeFatosInlineComVideoEla;
...
public class BoxListaDeFatosInlineComVideoElaTest {
	
	private static BoxListaDeFatosInlineComVideoEla materia;
	...
	public static void antesDeCadaTeste() throws Exception {
		materia = new BoxListaDeFatosInlineComVideoEla(Navegador.CHROME);
