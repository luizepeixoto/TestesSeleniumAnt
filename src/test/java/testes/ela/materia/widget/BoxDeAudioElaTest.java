...
import pages.ela.materia.widget.BoxDeAudioEla;
...
public class BoxDeAudioElaTest {
	
	private static BoxDeAudioEla materia;
	...
	public static void antesDeCadaTeste() throws Exception {
		materia = new BoxDeAudioEla(Navegador.CHROME);
		materia.esperaCarregar1Segundo();
		materia.executaScrollParaAparecerOTituloDeUmaPosicao(materia.boxDoAudio());
	}
