...
import pages.editoria.MenuDestaquesComColunaEsquerdaVazia;
...
public class DestaquesDoMenuComColunaEsquerdaVaziaTest {
	
	private static MenuDestaquesComColunaEsquerdaVazia menuDestaques;
	...
	public static void antesDeCadaTeste() throws Exception {
		menuDestaques = new MenuDestaquesComColunaEsquerdaVazia(Navegador.CHROME);
	}
	...
	@Test
	public void exibiuFotoParaOPrimeiroDestaqueOWidthEhDe380Px() throws InterruptedException{
		assertTrue(menuDestaques.oWidthDaFotoEhDe380Px());
	}
	
	@OrdemExecucaoTeste(Ordem=14)
	@Test
	public void exibiuFotoParaOPrimeiroDestaqueOHeightEhDe380Px() throws InterruptedException{
	...
	@Test
	public void exibiuFotoParaOSegundoDestaqueOWidthEhDe380Px() throws InterruptedException{
		assertTrue(menuDestaques.oWidthDaSegundaFotoEhDe380Px());
	}
	
	@OrdemExecucaoTeste(Ordem=17)
	@Test
	public void exibiuFotoParaOSegundoDestaqueOHeightEhDe380Px() throws InterruptedException{
	...
	@Test
	public void exibiuColunaDaEsquerdaComMateriasConfiguradas() throws InterruptedException{
		assertTrue(menuDestaques.exibiuColunaDaEsquerda());
	}
}
