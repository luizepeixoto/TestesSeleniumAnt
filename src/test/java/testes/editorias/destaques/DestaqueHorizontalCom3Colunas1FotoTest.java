...
import pages.editoria.destaques.DestaqueHorizontalCom3Colunas1Foto;


public class DestaqueHorizontalCom3Colunas1FotoTest {
	
	private static DestaqueHorizontalCom3Colunas1Foto editoria;
	
	@BeforeClass
	public static void antesDeCadaTeste() throws Exception {
		editoria = new DestaqueHorizontalCom3Colunas1Foto();
	}
	...
	@Test
	public void exibiuUmaFotonoDestaque(){
		assertTrue(editoria.getFoto());
	}
	
	@Test
	public void exibiuAFotoDoDestaqueComOWidthCorreto(){
		String widthEsperado="920";
		assertEquals(widthEsperado, editoria.getWidth());
	}
	
	@Test
	public void exibiuAFotoDoDestaqueComOHeightCorreto(){
		String heightEsperado="400";
		assertEquals(heightEsperado, editoria.getHeight());
	}
	...
	@Test
	public void exibiuTituloComMaisDe60aracteresNasMateriasRelacionadas(){
