...
import pages.editoria.MenuDestaquesComColunaEsquerdaVaziaSubEditoria;
...
public class DestaquesDoMenuComColunaEsquerdaVaziaSubEditoriaTest {
	
	private static MenuDestaquesComColunaEsquerdaVaziaSubEditoria menuDestaques;
	...
	public static void antesDeCadaTeste() throws Exception {
		menuDestaques = new MenuDestaquesComColunaEsquerdaVaziaSubEditoria(Navegador.CHROME);
	}
	...
	@Test
	public void seExibiuFotoParaOPrimeiroDestaqueOHeightEhDe230Px() throws InterruptedException{
	...
	@Test
	public void seExibiuFotoParaOSegundoDestaqueOHeightEhDe230Px() throws InterruptedException{
	...
	public void exibiuColunaDaEsquerdaComMateriasConfiguradas() throws InterruptedException{
		assertFalse(menuDestaques.exibiuColunaDaEsquerda());
	}
}
