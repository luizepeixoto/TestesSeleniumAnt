...
public class CapaEditoriaTealiumTest {
	
	private static MenuDestaquesComColunaEsquerdaVazia editoria;
	private String codigoFonte = editoria.getCodigoFonte();
		
	@BeforeClass
	public static void antesDeCadaTeste() throws Exception {
		editoria = new MenuDestaquesComColunaEsquerdaVazia(Navegador.CHROME);
	}
