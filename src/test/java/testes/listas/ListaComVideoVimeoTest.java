...
import pages.lista.ListaComVideoVimeo;
...
public class ListaComVideoVimeoTest {
	
	private static ListaComVideoVimeo lista;
	...
	public static void antesDeCadaTeste() throws Exception {
		lista = new ListaComVideoVimeo(Navegador.CHROME);
	...
	public void verificaSeParaCadaUmDosFatosEstaSendoExibidoUmTituloDescricaoContadorEVideoDaGloboCom() throws InterruptedException {
		assertTrue(lista.exibiuTituloDescricaoContadorVideoDoVimeoComParaCadaFato());
	}
