...
import pages.lista.ListaComVideoVevo;
...
public class ListaComVideoVevoTest {
	
	private static ListaComVideoVevo lista;
	...
	public static void antesDeCadaTeste() throws Exception {
		lista = new ListaComVideoVevo(Navegador.CHROME);
	...
	public void verificaSeParaCadaUmDosFatosEstaSendoExibidoUmTituloDescricaoContadorEVideoDaGloboCom() throws InterruptedException {
		assertTrue(lista.exibiuTituloDescricaoContadorVideoDoVevoComParaCadaFato());
	}
