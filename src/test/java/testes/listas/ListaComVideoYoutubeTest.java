...
import pages.lista.ListaComVideoYoutube;
...
public class ListaComVideoYoutubeTest {
	
	private static ListaComVideoYoutube lista;
	...
	public static void antesDeCadaTeste() throws Exception {
		lista = new ListaComVideoYoutube(Navegador.CHROME);
	...
	public void verificaSeParaCadaUmDosFatosEstaSendoExibidoUmTituloDescricaoContadorEVideoDaGloboCom() throws InterruptedException {
		assertTrue(lista.exibiuTituloDescricaoContadorVideoDoYoutubeComParaCadaFato());
	}
