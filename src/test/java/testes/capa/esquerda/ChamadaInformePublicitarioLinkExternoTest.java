...
import pages.capa.esquerda.ChamadaInformePublicitarioLinkExterno;

public class ChamadaInformePublicitarioLinkExternoTest {
	
	private static ChamadaInformePublicitarioLinkExterno chamada;
	
	@BeforeClass
	public static void antesDeCadaTeste() throws Exception {
		chamada = new ChamadaInformePublicitarioLinkExterno();
	}
