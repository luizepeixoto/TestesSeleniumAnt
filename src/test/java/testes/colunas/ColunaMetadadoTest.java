...
import pages.coluna.ColunaMetadado;


public class ColunaMetadadoTest {
	
	private static ColunaMetadado coluna;
	private String contextoPagina = coluna.exibiuCodigoFonteDaPagina(); 
	
	@BeforeClass
	public static void antesDeCadaTeste() throws Exception {
		coluna = new ColunaMetadado();
	}
	...
	public void verificaSeAMetatagTwitterCardEstaSendoCarregadoNoCodigoDaPagina(){
		assertTrue(contextoPagina.contains("<meta name=\"twitter:card\""));
	}
	...
	public void verificaSeAMetatagItempropDescriptionEstaSendoCarregadoNoCodigoDaPagina(){
		assertTrue(contextoPagina.contains("<h2 itemprop=\"description\">"));
	}
