...
public class LibertadoresNoTempoRealFaseQuartasDeFinalTest {
	...
	public static void before() throws Exception{
		libertadoresPaginaTempoReal = new TabelaLibertadoresFaseMataMataPaginaTempoRealPaginaPadrao(Navegador.CHROME, FasesMataMata.QUARTAS);
