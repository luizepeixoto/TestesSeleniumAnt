...
import pages.tabelas.libertadores.paginaTempoReal.TabelaLibertadoresPaginaTempoReal;
...
public class LibertadoresNoTempoRealTest {

	private static TabelaLibertadoresPaginaTempoReal libertadores;
	...
	public static void before() throws Exception{
		libertadores = new TabelaLibertadoresPaginaTempoReal(Navegador.CHROME);
	...
	@Test
	public void verificaSeALarguraDaTabelaEhIgualALarguraDoBoxDeCabecalho() {
		assertTrue(libertadores.exibiuALarguraDaTabelaIgualALarguraDoBoxDeCabecalho());
	}
}