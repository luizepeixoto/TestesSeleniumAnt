...
public class LibertadoresFaseFinalTest {
	...
	public static void before() throws Exception{
		libertadores = new TabelaLibertadoresFaseMataMataPaginaPadrao(Navegador.CHROME, FasesMataMata.FINAL);
	...
	@Test
	public void verificaSeAoClicarNaOpcaoDaFaseFinalOBoxDosJogosDestaFaseEhExibido() {
		assertTrue(libertadores.exibiuBoxDosJogosDaFaseAposClicarNoMenu());
	}
	
	@OrdemExecucaoTeste(Ordem = 2)
	@Test
	public void verificaSeNoMinimoUmJogoDaFaseFinalEstaSendoExibido() {
		assertTrue(libertadores.exibiuNoMinimoUmJogoDaFase());
	}
	
	@OrdemExecucaoTeste(Ordem = 3)
	@Test
	public void verificaSeParaCadaJogoDaFaseFinalAsInformacoesDeDataHoraEstadioNomeDasEquipesEEscudoDasEquipesEstaoSendoExibidas() {
