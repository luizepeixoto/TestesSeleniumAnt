...
public class LibertadoresFaseSemifinalTest {
	...
	public static void before() throws Exception{
		libertadores = new TabelaLibertadoresFaseMataMataPaginaPadrao(Navegador.CHROME, FasesMataMata.SEMIFINAL);
	...
	@Test
	public void verificaSeAoClicarNaOpcaoDaFaseSemifinalOBoxDosJogosDestaFaseEhExibido() {
		assertTrue(libertadores.exibiuBoxDosJogosDaFaseAposClicarNoMenu());
	}
	
	@OrdemExecucaoTeste(Ordem = 2)
	@Test
	public void verificaSeNoMinimoUmJogoDaFaseSemifinalEstaSendoExibido() {
		assertTrue(libertadores.exibiuNoMinimoUmJogoDaFase());
	}
	
	@OrdemExecucaoTeste(Ordem = 3)
	@Test
	public void verificaSeParaCadaJogoDaFaseSemifinalAsInformacoesDeDataHoraEstadioNomeDasEquipesEEscudoDasEquipesEstaoSendoExibidas() {
