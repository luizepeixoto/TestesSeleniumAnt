...
public class LibertadoresNoTempoRealFaseFinalTest {
	...
	public static void before() throws Exception{
		libertadoresPaginaTempoReal = new TabelaLibertadoresFaseMataMataPaginaTempoRealPaginaPadrao(Navegador.CHROME, FasesMataMata.FINAL);
