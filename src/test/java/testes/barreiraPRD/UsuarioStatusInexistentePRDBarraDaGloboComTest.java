...
public class UsuarioStatusInexistentePRDBarraDaGloboComTest {
	...
	public void fluxoNavegacaoRegisterWall() throws Exception{
		degustacao.logarNaBarraGloboPontoCom();
		login.efetuarLoginInexistenteBarraDaGloboCom();
