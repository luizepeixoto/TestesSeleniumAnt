...
import pages.ultimas.UltimasDeEditoria;

import br.com.infoglobo.pages.Navegador;
import br.com.infoglobo.pages.OrdemExecucaoTeste;

public class UltimasDeUmaEditoriaTest {
	
	private static UltimasDeEditoria ultimasNoticias;
	
	@BeforeClass
	public static void antesDeCadaTeste() throws Exception {
		ultimasNoticias = new UltimasDeEditoria(Navegador.CHROME);
