...
import pages.compartilhamento.CompartilharColuna;
...
public class CompartilharColunaTest {
	
	private static CompartilharColuna compartilhar;
	
	@BeforeClass
	public static void antesDeCadaTeste() throws Exception {
		compartilhar = new CompartilharColuna(Navegador.CHROME);
	}
