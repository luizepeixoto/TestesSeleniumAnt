...
import pages.compartilhamento.CompartilharMateria;
...
public class CompartilharMateriaIPADTest {
	
	private static CompartilharMateria compartilhar;
	
	@BeforeClass
	public static void antesDeCadaTeste() throws Exception {
		compartilhar = new CompartilharMateria(Navegador.CHROME_EMULADO, Device.IPAD);
	}
	...
	@Test
	public void verificarSeAOClicarNoGMaisUmDoGooglePlusEhAbertaUmaNovaJanelaDoBrowser() throws InterruptedException{
		compartilhar.clicarNoGMaisUmGoogle();
		assertTrue(compartilhar.abriuUmaNovaJanela());
