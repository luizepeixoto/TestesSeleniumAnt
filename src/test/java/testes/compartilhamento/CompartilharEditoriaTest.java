...
import pages.compartilhamento.CompartilharEditoria;
...
public class CompartilharEditoriaTest {
	
	private static CompartilharEditoria compartilhar;
	
	@BeforeClass
	public static void antesDeCadaTeste() throws Exception {
		compartilhar = new CompartilharEditoria(Navegador.CHROME);
	}
