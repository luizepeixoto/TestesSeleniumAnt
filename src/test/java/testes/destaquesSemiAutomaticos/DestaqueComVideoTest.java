...
import pages.destaques.DestaquesVideos;
...
public class DestaqueComVideoTest {
	
	private static DestaquesVideos destaque;
	
	@BeforeClass
	public static void antesDeCadaTeste() throws Exception {
		destaque = new DestaquesVideos(Navegador.CHROME);
