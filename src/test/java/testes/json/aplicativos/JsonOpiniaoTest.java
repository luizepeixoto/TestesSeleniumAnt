...
import pages.json.aplicativos.JsonOpiniao;
...
public class JsonOpiniaoTest {

	private static JsonOpiniao opiniao;
	...
	public Destination getDestination() {
		try {
			...
			context.addPathSegment( "caminho", opiniao.getUrlPaginaAtual().replace(urlDestino, ""));
	...
	public void verificaSeOJsonDeOpiniaoQuePreencheOsAplicativosEstaTrazendoConteudo() {
