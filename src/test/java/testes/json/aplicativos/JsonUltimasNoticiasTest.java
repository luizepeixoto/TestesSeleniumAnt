...
import pages.json.aplicativos.JsonUltimasNoticias;
...
public class JsonUltimasNoticiasTest {

	private static JsonUltimasNoticias home;
	...
	public Destination getDestination() {
		try {
			...
			final String caminho = home.getUrlPaginaAtual().replace(urlDestino, "");
	...
	public void verificaSeOJsonDaPaginaDeUltimasNoticiasQuePreencheOsAplicativosEstaTrazendoConteudo() {
