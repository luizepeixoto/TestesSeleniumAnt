...
import pages.json.aplicativos.JsonEsportes;
...
public class JsonEsportesTest {

	private static JsonEsportes esportes;
	...
	public Destination getDestination() {
		try {
			...
			context.addPathSegment( "caminho", esportes.getUrlPaginaAtual().replace(urlDestino, ""));
	...
	public void verificaSeOJsonDaPaginaDeEsportesQuePreencheOsAplicativosEstaTrazendoConteudo() {
