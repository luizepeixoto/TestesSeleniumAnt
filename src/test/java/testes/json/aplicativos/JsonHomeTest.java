...
import pages.json.aplicativos.JsonHome;
...
public class JsonHomeTest {
	...
	public Destination getDestination() {
		try {
			...
			context.addPathSegment( "caminho", home.getUrlPaginaAtual().replace(urlDestino, ""));
	...
	public void verificaSeOJsonDaCapaDoSiteQuePreencheOsAplicativosEstaTrazendoConteudo() {
