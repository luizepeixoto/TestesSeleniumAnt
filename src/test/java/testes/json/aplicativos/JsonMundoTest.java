...
import pages.json.aplicativos.JsonMundo;
...
public class JsonMundoTest {

	private static JsonMundo mundo;
	...
	public Destination getDestination() {
		try {
			...
			context.addPathSegment( "caminho", mundo.getUrlPaginaAtual().replace(urlDestino, ""));
	...
	public void verificaSeOJsonDaPaginaDeMundoQuePreencheOsAplicativosEstaTrazendoConteudo() {
