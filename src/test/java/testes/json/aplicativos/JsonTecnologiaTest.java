...
import pages.json.aplicativos.JsonTecnologia;
...
public class JsonTecnologiaTest {

	private static JsonTecnologia tecnologia;
	...
	public Destination getDestination() {
		try {
			...
			context.addPathSegment( "caminho", tecnologia.getUrlPaginaAtual().replace(urlDestino, ""));
	...
	public void verificaSeOJsonDaPaginaDeTecnologiaQuePreencheOsAplicativosEstaTrazendoConteudo() {
