...
import pages.json.aplicativos.JsonCultura;
...
public class JsonCulturaTest {

	private static JsonCultura cultura;
	...
	public Destination getDestination() {
		try {
			...
			context.addPathSegment( "caminho", cultura.getUrlPaginaAtual().replace(urlDestino, ""));
	...
	public void verificaSeOJsonDaPaginaDeCulturaQuePreencheOsAplicativosEstaTrazendoConteudo() {
