...
public class MateriaComVideoGlobo extends AceitacaoAbstractTest {
	
	public MateriaComVideoGlobo(Navegador navegador) throws Exception {
		super(navegador);
	}
	...
	public boolean exibiuVideoDaGloboCom(){
		return getListaVideo().get(0).getAttribute("id").contains("player-wrapper2");
	}
}