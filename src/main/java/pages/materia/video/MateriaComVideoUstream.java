...
public class MateriaComVideoUstream extends AceitacaoAbstractTest {
	
	public MateriaComVideoUstream(Navegador navegador) throws Exception {
		super(navegador);
	}
	...
	public boolean getVideoUstream(){
		return getListaVideo().get(0).findElement(By.tagName("div")).findElement(By.tagName("iframe")).getAttribute("src").contains("ustream");
	}
}