...
public class MateriaNavegacaoSemAnterior extends AceitacaoAbstractTest {
	
	public MateriaNavegacaoSemAnterior(Navegador navegador) throws Exception {
		super(navegador);
	}
	...
	public boolean exibiuOTituloDoBoxAnteriorIgualAoTituloDaMateria(){
		String materiaTitulo = getDriver().findElement(By.className("head-materia")).findElement(By.tagName("h1")).getText();
