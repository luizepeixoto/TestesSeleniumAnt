...
public class MenuLateralComComentario extends AceitacaoAbstractTest {
	
	public MenuLateralComComentario() throws Exception {
		super();
	}
	
	public MenuLateralComComentario(Navegador navegador) throws Exception {
		super(navegador);
	}
