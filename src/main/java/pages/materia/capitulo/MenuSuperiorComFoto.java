...
public class MenuSuperiorComFoto extends AceitacaoAbstractTest {
	
	public MenuSuperiorComFoto() throws Exception {
		super();
	}
	
	public MenuSuperiorComFoto(Navegador navegador) throws Exception {
		super(navegador);
	}
	...
	public boolean exibiuONumeroDeCadaCapitulo() {
		for(int i=0; i<listaTotalDeMaterias().size(); i++){
			if(listaTotalDeMaterias().get(i).findElement(By.className("base-cap")).findElement(By.className("number")).getText().isEmpty()){
				return false;
			}
		}
		return true;
	...
	public boolean exibiuONumeroCorretoParaCadaCapitulo() {
		for(int i=0; i<listaTotalDeMaterias().size(); i++){
			if(! listaTotalDeMaterias().get(i).findElement(By.className("base-cap")).findElement(By.className("number")).getText().equals(String.valueOf(i+1))){
				return false;
			}
		}
		return true;
	...
	public boolean exibiuUmAntiTituloParaCadaCapitulo() {
		for(int i=0; i<listaTotalDeMaterias().size(); i++){
			if(listaTotalDeMaterias().get(i).findElement(By.className("base-cap")).findElement(By.className("ante-titulo")).getText().isEmpty()){
				return false;
			}
		}
		return true;
	...
	public boolean exibiuUmTituloParaCadaCapitulo() {
		for(int i=0; i<listaTotalDeMaterias().size(); i++){
			if(listaTotalDeMaterias().get(i).findElement(By.className("capitulo")).findElement(By.className("titulo")).getText().isEmpty()){
				return false;
			}
		}
		return true;
	...
	public boolean exibiuUmAutorParaCadaCapitulo() {
		for(int i=0; i<listaTotalDeMaterias().size(); i++){
			if(listaTotalDeMaterias().get(i).findElement(By.className("capitulo")).findElement(By.className("autor")).getText().isEmpty()){
				return false;
			}
		}
		return true;
	...
	public boolean exibiuUmaFotoParaCadaCapitulo() {
		for(int i=0; i<listaTotalDeMaterias().size(); i++){
			if(!listaTotalDeMaterias().get(i).findElement(By.className("bgParallax")).getAttribute("style").contains("background-image")){
				return false;
			}
		}
		return true;
	...
	public boolean exibiuAnimacaoParallaxUmaFotoNaAberturaDosCapitulo() {
		for(int i=0; i<listaTotalDeMaterias().size(); i++){
			if(!listaTotalDeMaterias().get(i).findElement(By.className("bgParallax")).isDisplayed()){
				return false;
			}
		}
		return true;
	...
	public boolean exibiuLegendaParaAsFotosNaAberturaDosCapitulos() {
		for(int i=0; i<listaTotalDeMaterias().size(); i++){
			if(listaTotalDeMaterias().get(i).findElement(By.className("caption")).findElement(By.tagName("p")).getText().isEmpty()){
				return false;
			}
		}
		return true;
	...
	public boolean exibiuAutorNasLegendasDasFotosNaAberturaDosCapitulos() {
		for(int i=0; i<listaTotalDeMaterias().size(); i++){
			if(listaTotalDeMaterias().get(i).findElement(By.className("caption")).findElement(By.tagName("b")).getText().isEmpty()){
				return false;
			}
		}
		return true;
