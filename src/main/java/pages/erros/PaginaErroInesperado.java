...
public class PaginaErroInesperado extends AceitacaoAbstractTest {
	
	public PaginaErroInesperado() throws Exception {
		super();
	}
	
	public PaginaErroInesperado(Navegador navegador) throws Exception {
		super(navegador);
	}
	...
	public boolean exibiuBotaoDeBusca() {
		return exibiuBoxDeFormulario().findElement(By.className("search-submit")).isDisplayed();
	}
	...
	public boolean executarBuscaErroInesperado() throws InterruptedException {
