...
public class CapaMeioMancheteInformePublicitarioLinkExterno extends AceitacaoAbstractTest {
	
	public CapaMeioMancheteInformePublicitarioLinkExterno() throws Exception {
		super();
	}
