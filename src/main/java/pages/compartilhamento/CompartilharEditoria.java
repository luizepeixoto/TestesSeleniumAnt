...
public class CompartilharEditoria extends AceitacaoAbstractTest {
	
	public CompartilharEditoria() throws Exception {
		super();
	}
	
	public CompartilharEditoria(Navegador navegador) throws Exception {
		super(navegador);
	}
