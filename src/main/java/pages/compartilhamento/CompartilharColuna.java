...
public class CompartilharColuna extends AceitacaoAbstractTest {
	
	public CompartilharColuna() throws Exception {
		super();
	}
	
	public CompartilharColuna(Navegador navegador) throws Exception {
		super(navegador);
	}
