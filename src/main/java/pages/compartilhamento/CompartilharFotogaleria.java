...
public class CompartilharFotogaleria extends AceitacaoAbstractTest {
	
	public CompartilharFotogaleria() throws Exception {
		super();
	}
	
	public CompartilharFotogaleria(Navegador navegador) throws Exception {
		super(navegador);
	}
