...
public class EditoriaInformeDestaqueGrande extends AceitacaoAbstractTest {
	
	public EditoriaInformeDestaqueGrande() throws Exception {
		super();
	}
	
	public EditoriaInformeDestaqueGrande(Navegador navegador) throws Exception {
		super(navegador);
	}
