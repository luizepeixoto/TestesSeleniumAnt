...
public class BoxDeUltimasNoticiasDeEditoria extends AceitacaoAbstractTest {
	
	//box de últimas notícias, configurado em uma editoria apontando para outra editoria. Não Incluir o flag de subeditorias
	
	public BoxDeUltimasNoticiasDeEditoria() throws Exception{
		super();
	}
	
	public BoxDeUltimasNoticiasDeEditoria(Navegador navegador) throws Exception{
		super(navegador);
	}
