...
public class MenuDestaquesComColunaEsquerdaVazia extends MarcacoesDoTealium {

	public MenuDestaquesComColunaEsquerdaVazia() throws Exception {
		super();
	}
	
	public MenuDestaquesComColunaEsquerdaVazia(Navegador navegador) throws Exception {
		super(navegador);
	}
...
//		Thread.sleep(2000);
	...
	public boolean exibiuColunaDaEsquerda(){
		List<WebElement> exibiuMaterias = getDriver().findElement(By.className("col-left")).findElements(By.className("editorias"));
		return exibiuMaterias.size()==0;
	}
