...
public class BoxDeUltimasNoticiasDeSubEditoria extends AceitacaoAbstractTest {

	//Box de Ultimas dentro de uma SubEditoria, apontando para a editoria porém com o flag de subeditorias marcado.
	
	public BoxDeUltimasNoticiasDeSubEditoria() throws Exception{
		super();
	}
